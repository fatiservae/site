  ...
  .then(data => {
      for (i=0; i < Object.keys(data).length; i++){
        ...
        habitual.innerText = "Dose habitual de "+atbAtual.posologias[1][0]+atbAtual.posologias[0][0]+'/'+atbAtual.posologias[1][1]+atbAtual.posologias[0][1];
        ...
        if (noPosologias > 2) {
            ...
            for (j=1; j < noPosologias; j++){
              let instrucoes = atbAtual.posologias[j][3] === undefined ? '' : " "+atbAtual.posologias[j][3];
              posologiasAdc.innerHTML+= j+") "+atbAtual.posologias[j][0]+atbAtual.posologias[0][0]+'/'+atbAtual.posologias[j][1]+atbAtual.posologias[0][1]+" via "+atbAtual.posologias[j][2]+instrucoes+".<br><br>";
            }
        }
